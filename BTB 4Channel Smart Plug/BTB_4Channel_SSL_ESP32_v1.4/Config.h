...
extern float voltagePre2;
extern float currentPre2;
extern float powerPre2;
...
extern float samplesForPowerCSE1[];    // buffer to store samples
extern int indexForPowerCSE1;          // current position
extern bool bufferFilledForPowerCSE1;  // flag to know when buffer is full

// extern int indexForCurrentCSE1;
// extern bool bufferFilledForCurrentCSE1;
// extern float samplesForCurrentCSE1[];

// extern int indexForVoltageCSE1;
// extern bool bufferFilledForVoltageCSE1;
// extern float samplesForVoltageCSE1[];

extern float samplesForPowerCSE2[];    // buffer to store samples
extern int indexForPowerCSE2;          // current position
extern bool bufferFilledForPowerCSE2;  // flag to know when buffer is full

// extern int indexForCurrentCSE2;
// extern bool bufferFilledForCurrentCSE2;
// extern float samplesForCurrentCSE2[];

// extern int indexForVoltageCSE2;
// extern bool bufferFilledForVoltageCSE2;
// extern float samplesForVoltageCSE2[];
