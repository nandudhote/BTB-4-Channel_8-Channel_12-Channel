...
public:
  ...
  void clientLoop();
  void publishMqttMsg(String pubTopic, String devID, float voltage, float current, double power, float voltage1, float current1, double power1, bool loadStatus1, bool loadStatus2, bool loadStatus3, bool loadStatus4);
