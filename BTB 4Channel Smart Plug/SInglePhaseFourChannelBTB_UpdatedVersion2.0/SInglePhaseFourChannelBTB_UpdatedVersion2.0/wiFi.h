...
class WIFI {
  public:
    ...
    void clientLoop();
    void publishMqttMsg(String pubTopic, String devID, float voltage, float current, float power, bool loadOneStatus, bool loadTwoStatus, bool loadThreeStatus, bool loadFourStatus);
